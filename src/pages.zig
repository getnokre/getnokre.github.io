...
pub const all = [_]Page{
    ...
    .{
        .name = "internals.axes",
        .title = .titleInternalsAxes,
        .blurb = .blurbInternalsAxes,
        .icon = .lucide_axis_3d,
        .md = "internals/axes.md",
        .track = .contributor,
    },

    .{
        .name = "internals.substrates",
        .title = .titleInternalsSubstrates,
        .blurb = .blurbInternalsSubstrates,
        .icon = .lucide_component,
        .md = "internals/substrates.md",
        .track = .contributor,
    },
    .{
